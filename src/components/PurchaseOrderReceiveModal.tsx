      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
          ...
          {wasStockAlreadyReceived ? (
            ...
            <div className="bg-slate-100 p-4 rounded-2xl border border-slate-200/90 space-y-3">
                  ...
                  <div className="absolute right-0 top-full mt-1.5 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-slate-200 z-40 p-2 space-y-2 animate-in fade-in zoom-in-95 duration-150">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-1.5 bg-slate-100 border border-slate-200 rounded-xl text-xs font-bold text-slate-900 focus:bg-white focus:outline-hidden focus:border-emerald-600"
                        autoFocus
                      />
                    </div>
                        ...
                        <tr key={item.tempId} className="hover:bg-slate-100/80 transition-colors">
                          ...
                          <td className="py-2.5 px-3 text-right">
                            <input
                              ...
                              className="w-28 px-2 py-1 bg-slate-100 border border-slate-300 rounded-lg text-xs font-black text-right text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 font-mono shadow-sm"
                            />
                          </td>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-slate-100 border border-slate-200 rounded-xl text-xs font-medium text-slate-900 placeholder:text-slate-400 focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 transition-all shadow-sm"
            />
          </div>
        </form>
