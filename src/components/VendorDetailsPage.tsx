...
export const VendorDetailsPage: React.FC<VendorDetailsPageProps> = ({
  ...
  return (
    <div id="vendor-details-page" className="space-y-6">
      ...
      <div className="bg-white border border-neutral-200 shadow-sm p-4 sm:p-5 rounded-3xl">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {onOpenCreatePO && (<button
                ...
                className="px-3.5 py-2 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold shadow-sm transition-colors flex items-center gap-1.5 cursor-pointer"
            ...
            {onOpenPurchaseModal ? <button
              type="button"
              id="btn-vendor-details-record-purchase"
              onClick={() => onOpenPurchaseModal(vendor.id)}
              className="px-3.5 py-2 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-white text-xs font-bold shadow-sm transition-colors flex items-center gap-1.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="p-2 sm:px-3 sm:py-2 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-200 text-xs font-bold shadow-sm transition-colors flex items-center gap-1.5 cursor-pointer"
            ...
            {activeTab === 'ledger' && (
              <div className="flex items-center gap-2 py-2 flex-wrap">
                ...
                <button
                  ...
                  onClick={() => downloadVendorLedgerPDF(vendor, fullLedger, currentBalance, 'Complete Ledger Statement')}
                  className="px-3.5 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-900 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer border border-amber-200 shadow-sm"
                  title="Download complete vendor statement report as PDF"
                >
                          ...
                          >
                            ...
                            <td className="px-3 py-3 text-center whitespace-nowrap" onClick={e => e.stopPropagation()}>
                              <div className="flex items-center justify-center gap-1">
                                  ...
                                  return (
                                    <>
                                      {pur ? (
                                        ...
                                        <>
                                          {onOpenReceivePO && (<button
                                              type="button"
                                              onClick={() => onOpenReceivePO(linkedPO)}
                                              className="px-2 py-0.5 rounded text-[11px] font-bold bg-amber-600 hover:bg-amber-700 text-white flex items-center gap-1 shadow-sm"
                                ...
                                {row.sourceType === 'opening_balance' && ( onOpenEditVendorModal ? <button
                                    type="button"
                                    onClick={() => onOpenEditVendorModal(vendor)}
                                    className="p-1 rounded text-neutral-400 hover:text-amber-700 hover:bg-neutral-100"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {linkedProducts.map(prod => {
                    ...
                    return (
                      <div
                        key={prod.id}
                        className="bg-neutral-50 rounded-xl p-3.5 border border-neutral-200 hover:border-amber-300 hover:bg-white transition-all shadow-sm"
                      >
