  ...
  return (
    <div id="inventory-audit-log-view" className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 p-5 sm:p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-2xl bg-red-50 border border-red-200 flex items-center justify-center text-red-600 shrink-0 shadow-sm">
            ...
            <div>
              <div className="flex items-center gap-2.5 flex-wrap">
                ...
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-slate-200 text-slate-700 border border-slate-200">
          ...
          <div className="flex items-center gap-2.5 shrink-0 self-start md:self-center">
            {onRefresh && (
              <button
                ...
                className="inline-flex items-center justify-center p-2.5 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-300 hover:text-slate-900 transition-colors"
              >
            ...
            <div className="relative">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 text-white hover:bg-slate-800 text-sm font-semibold shadow-sm transition-colors"
              >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 mt-6 pt-6 border-t border-slate-100">
          <div className="p-3.5 bg-slate-200 rounded-xl border border-slate-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3">
          ...
          <div className="lg:col-span-4 relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3.5 py-2 text-sm bg-slate-200 border border-slate-200 rounded-xl focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-red-500/20 focus:border-red-500 transition-all text-slate-900"
            />
            {searchTerm && (
              <button
                onClick={() => {
          ...
          <div className="lg:col-span-3">
            <select
              ...
              className="w-full px-3 py-2 text-sm bg-slate-200 border border-slate-200 rounded-xl focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-red-500/20 focus:border-red-500 text-slate-800 font-medium"
            >
            ...
            <>
              <div className="lg:col-span-2">
                <input
                  ...
                  className="w-full px-3 py-2 text-xs bg-slate-200 border border-slate-200 rounded-xl focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-red-500/20 focus:border-red-500 text-slate-800 font-medium"
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
        ...
        <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between flex-wrap gap-3 bg-slate-200/50">
        ...
        {paginatedLogs.length === 0 ? (
          <div className="p-12 text-center">
            <div className="w-14 h-14 rounded-2xl bg-slate-200 flex items-center justify-center text-slate-400 mx-auto mb-4">
            ...
            {hasActiveFilters && (
              <button
                onClick={handleResetFilters}
                className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-200 hover:bg-slate-300 text-slate-700 text-sm font-semibold transition-colors"
              >
                <RefreshCw className="w-4 h-4" />
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[900px]">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-200/80 text-[11px] font-bold text-slate-500 uppercase tracking-wider select-none">
                    ...
                    >
                        ...
                        <div className="flex items-start gap-2.5">
                          <div className="min-w-0">
                            <div className="flex items-center gap-2 flex-wrap">
                              {log.internalId && (
                                <span className="px-2 py-0.5 rounded-md text-[11px] font-mono font-bold bg-slate-200 text-slate-700 border border-slate-200">
                                  {log.internalId}
                                </span>
                              )}
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center justify-center gap-2 font-mono">
                          ...
                          <div className="px-2.5 py-1 rounded-lg bg-slate-200 border border-slate-200 text-center min-w-[50px]">
                          ...
                          {/* New Stock Snapshot */}
                          <div className="px-2.5 py-1 rounded-lg bg-slate-900 text-white border border-slate-800 text-center min-w-[50px] shadow-sm">
                      ...
                      <td className="py-3.5 px-4 text-right whitespace-nowrap" onClick={e => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          {onOpenAdjustModal && (<button
                              ...
                              className="p-1.5 rounded-lg border border-slate-200 text-slate-600 hover:text-slate-900 hover:bg-slate-300 transition-colors"
                            >
        ...
        {/* 5. Pagination Footer */}
        {sortedLogs.length > 0 && (
          <div className="px-5 py-4 border-t border-slate-100 bg-slate-200/50 flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="px-3 py-1.5 rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-300 disabled:opacity-40 disabled:pointer-events-none transition-colors"
              >
                Previous
              </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="p-5 sm:p-6 space-y-4 max-h-[80vh] overflow-y-auto">
              {/* Product Info Banner */}
              <div className="bg-slate-200 rounded-2xl p-4 border border-slate-200">
                <div className="flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="p-3 bg-slate-200 rounded-xl border border-slate-100">
              ...
              {/* Notes / Details */}
              {selectedLog.notes && (
                <div className="p-3.5 bg-slate-200 rounded-xl border border-slate-200">
              ...
              <div className="flex items-center justify-between gap-3 pt-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-200 hover:bg-slate-300 text-slate-700 text-xs font-bold transition-colors"
                >
      ...
      {timelineProductId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150 flex flex-col max-h-[90vh]">
            ...
            {/* Product Summary Bar */}
            {timelineProduct && (
              <div className="bg-slate-200 px-6 py-3 border-b border-slate-200 flex items-center justify-between flex-wrap gap-2 text-xs shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  {timelineLogs.map((log, idx) => {
                    ...
                    return (
                      <div key={log.id} className="relative group">
                        {/* Timeline Node Dot */}
                        <div className={`absolute -left-6 top-1.5 w-5 h-5 rounded-full border-2 border-white shadow-sm flex items-center justify-center ${meta.dot}`}>
                        </div>

                        {/* Event Card */}
                        <div className="bg-slate-200 hover:bg-white hover:shadow-md border border-slate-200 rounded-2xl p-4 transition-all">
                          <div className="flex items-center justify-between flex-wrap gap-2">
                            <div className="flex items-center gap-2">
            ...
            {/* Footer */}
            <div className="bg-slate-200 px-6 py-3.5 border-t border-slate-200 flex items-center justify-end shrink-0">
              <button
                onClick={() => setTimelineProductId(null)}
                className="px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold transition-colors"
              >
