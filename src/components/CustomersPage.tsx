      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 sm:p-6 rounded-3xl border border-slate-200 shadow-sm">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {isActionAllowed(currentEmployee, 'canManageCustomers') && <button
            ...
            className="px-3.5 py-2 bg-white hover:bg-slate-300 border border-slate-200 text-slate-800 rounded-2xl text-xs font-black shadow-sm transition-all flex items-center gap-1.5 cursor-pointer"
          >
      ...
      <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200 shadow-sm space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-200 border border-slate-200 focus:border-red-500 focus:bg-white rounded-2xl text-xs font-bold text-slate-900 outline-hidden transition-all placeholder:text-slate-400"
          />
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pt-1">
          ...
          <div className="flex items-center gap-1.5 p-1 bg-slate-200 rounded-2xl flex-wrap">
            <button
              type="button"
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <select
              ...
              className="px-3 py-2 bg-slate-200 border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 outline-hidden cursor-pointer"
            >
          ...
          {filteredCustomers.map((cust) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className={`p-3 rounded-2xl border flex items-center justify-between ${
                    bal > 0 
                      ...
                      : (bal < 0 ? 'bg-emerald-50/80 border-emerald-200 text-emerald-950' : 'bg-slate-200 border-slate-200 text-slate-700')
                  }`}>
                ...
                {/* Card Footer Actions */}
                <div className="px-5 py-3 bg-slate-200/90 border-t border-slate-100 rounded-b-3xl flex items-center justify-between gap-2">
                  <button
                    type="button"
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="p-1.5 px-2 bg-slate-200 hover:bg-slate-300 text-slate-700 rounded-xl text-[11px] font-bold transition-colors flex items-center gap-1 cursor-pointer"
