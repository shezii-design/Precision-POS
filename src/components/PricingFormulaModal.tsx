    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2.5 sm:p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl border border-red-100 w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150 my-2 sm:my-8">
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-h-[75vh] overflow-y-auto">
                  ...
                  >
                    ...
                    <div className="sm:col-span-5">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-1.5 bg-slate-200 border border-slate-300 rounded-lg text-xs sm:text-sm font-bold text-slate-800 focus:outline-hidden focus:ring-2 focus:ring-red-500/20 focus:border-red-500"
                      />
                    </div>
                    ...
                    <div className="sm:col-span-3">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-3 py-1.5 bg-slate-200 border border-slate-300 rounded-lg text-xs sm:text-sm font-bold text-red-600 focus:outline-hidden focus:ring-2 focus:ring-red-500/20 focus:border-red-500 pr-7"
                        />
          ...
          <label className="flex items-start gap-3 p-3 sm:p-3.5 bg-slate-200 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-300/70 transition-colors">
            <input
              type="checkbox"
        ...
        {/* Footer */}
        <div className="px-4 sm:px-6 py-3.5 sm:py-4 bg-slate-200 border-t border-slate-200 flex items-center justify-end gap-2.5">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 text-xs sm:text-sm font-semibold text-slate-600 hover:text-slate-900 bg-slate-200 border border-slate-300 rounded-xl hover:bg-slate-300 transition-colors"
          >
            Cancel
          </button>
          <button
