  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2.5 sm:p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-white rounded-3xl shadow-2xl border border-red-100 w-full max-w-3xl overflow-hidden animate-in fade-in zoom-in-95 duration-150 my-2 sm:my-8">
        ...
        {/* Tab Navigation */}
        <div className="flex border-b border-slate-200 bg-slate-200 text-xs font-bold px-3 sm:px-6 gap-1 pt-2 overflow-x-auto whitespace-nowrap">
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-5 max-h-[65vh] overflow-y-auto">
            ...
            {activeTab === 'basic' && (
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                  ...
                  <div className="md:col-span-4">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-slate-200 border border-slate-300 rounded-xl text-xs font-mono font-bold text-red-600 focus:bg-white focus:outline-hidden focus:border-red-500"
                    />
                  ...
                  <div className="md:col-span-8">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-slate-200 border border-slate-300 rounded-xl text-sm font-bold text-slate-900 focus:bg-white focus:outline-hidden focus:border-red-500"
                    />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    {showNewBrandInput ? (
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 bg-slate-200 border border-slate-300 rounded-xl text-xs font-bold text-slate-800 focus:bg-white focus:outline-hidden focus:border-red-500"
                      >
                        {brands.map((b) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {showNewLocationInput ? (
                      <div className="space-y-2 bg-slate-200 p-2 rounded-xl border border-red-200">
                        <input
                          type="text"
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 bg-slate-200 border border-slate-300 rounded-xl text-xs font-mono font-bold text-slate-900 focus:bg-white focus:outline-hidden focus:border-red-500"
                      />
                      {selectedLocationItem?.cabins && (
                        <select
                          onChange={(e) => setCabinNumber(e.target.value)}
                          value={cabinNumber}
                          className="w-28 px-2 py-1.5 bg-slate-200 border border-slate-300 rounded-xl text-xs font-mono text-slate-700"
                        >
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-slate-200 border border-slate-300 rounded-xl text-xs font-bold text-slate-900 focus:bg-white focus:outline-hidden focus:border-red-500"
                    >
                ...
                {/* Product Image */}
                <div className="space-y-2 bg-slate-200 p-3.5 rounded-xl border border-slate-200">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 space-y-1.5">
                      <input
                        ...
                        className="w-full px-3 py-1.5 bg-slate-200 border border-slate-300 rounded-lg text-xs"
                      />
                      <div className="flex items-center gap-2">
                        <label className="px-3 py-1 bg-slate-200 border border-slate-300 rounded-lg text-xs font-bold text-slate-700 hover:bg-slate-300 cursor-pointer shadow-sm inline-flex items-center gap-1.5">
            ...
            {activeTab === 'dimensions' && (
              <div className="space-y-5">
                ...
                <div className="text-[11px] text-slate-500 bg-slate-200 p-2 rounded-lg border border-slate-200">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      <select
                        ...
                        className="text-[10px] font-bold text-slate-500 bg-slate-200 rounded border border-slate-200 px-1 py-0.5"
                      >
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-200 border border-slate-300 rounded-xl text-xs font-bold text-slate-900 focus:bg-white focus:outline-hidden focus:border-red-500 pr-10"
                      />
            ...
            {activeTab === 'pricing' && (
              <div className="space-y-4">
                ...
                {productToEdit?.costBatches && productToEdit.costBatches.length > 0 && (
                  <div className="bg-slate-200 border border-slate-200 rounded-2xl p-4 space-y-2.5">
                    <div className="flex items-center justify-between">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 bg-slate-200 border border-slate-300 rounded-xl text-xs font-mono text-slate-800 focus:bg-white focus:outline-hidden focus:border-red-500 leading-relaxed"
                  />
                </div>
          ...
          {/* Footer Actions */}
          <div className="px-6 py-4 bg-slate-200 border-t border-slate-200 flex items-center justify-between">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-xs font-bold text-slate-600 hover:text-slate-900 bg-slate-200 border border-slate-300 rounded-xl hover:bg-slate-300 transition-colors"
            >
              Cancel
            </button>
            <button
