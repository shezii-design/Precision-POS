    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-5">
          ...
          <div className="bg-slate-200/80 p-4 rounded-xl border border-slate-200 space-y-4">
                      ...
                      return (
                        <div
                          ...
                          className={`p-2.5 text-xs flex items-center justify-between transition-colors ${
                            isFullyReturned 
                              ? 'bg-slate-200 opacity-60 cursor-not-allowed hover:bg-slate-300' 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="sm:col-span-2">
                ...
                <select
                  ...
                  className="w-full h-10 px-3 text-xs font-semibold bg-slate-200 border border-slate-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:outline-none"
                  required
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3 text-xs font-bold font-mono bg-slate-200 border border-slate-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:outline-none uppercase"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3 text-xs font-medium bg-slate-200 border border-slate-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:outline-none uppercase"
                />
              </div>
            </div>
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        {item.internalId && (
                          <span className="px-1.5 py-0.5 text-[10px] font-mono font-bold bg-slate-200 text-slate-600 rounded">
                            {item.internalId}
                          </span>
                        )}
                        {matchedProd && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-12 gap-2.5">
                      ...
                      <div className="sm:col-span-5">
                        ...
                        <select
                          ...
                          className="w-full h-9 px-2.5 text-xs font-medium bg-slate-200 border border-slate-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:outline-none"
                        >
                        ...
                        <input
                          ...
                          className={`w-full h-9 px-2.5 text-xs font-bold border rounded-lg focus:ring-2 focus:outline-none ${
                            isOverLimit 
                              ...
                              : 'bg-slate-200 border-slate-200 focus:ring-red-500'
                          }`}
                          required
                        />
                      </div>
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full h-9 px-2.5 text-xs font-bold bg-slate-200 border border-slate-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:outline-none"
                          required
                        />
                      </div>
                      ...
                      <div className="sm:col-span-3 flex flex-col justify-end">
                        ...
                        <div className="h-9 px-2.5 bg-slate-200 rounded-lg border border-slate-200 flex items-center justify-between text-xs font-black text-slate-900">
                          <span>Rs.</span>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1 border-t border-slate-100">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full h-8 px-2 text-[11px] font-medium bg-slate-200 border border-slate-200 rounded-lg focus:outline-none"
                        >
          ...
          <div className="bg-slate-200/80 p-4 rounded-xl border border-slate-200 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full h-10 px-3 text-xs font-bold bg-slate-200 border border-slate-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:outline-none"
                >
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full p-2.5 text-xs bg-slate-200 border border-slate-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:outline-none"
              />
            </div>
